...
class ColorConfiguration: NSObject {
    ...
    static var leftBaloonColor = UIColor(red: 0.957, green: 0.957, blue: 0.957, alpha: 1)
    
    /// Your right baloon color, using UIColor class, Default value : UIColor(red: 165/255.0, green: 226/255.0, blue: 221/255.0, alpha: 1.0)
    static var rightBaloonColor = UIColor(red: 0, green: 0.443, blue: 0.733, alpha: 1)
    ...
    static var leftBaloonTextColor : UIColor = #colorLiteral(red: 0.4, green: 0.4, blue: 0.4, alpha: 1)
