...
class QPopUpView: UIViewController {
    ...
    fileprivate init() {
        super.init(nibName: "QPopUpView", bundle:QiscusMultichannelWidget.bundle)
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if self.image != nil {
            ...
            self.ivFileAttachment.image = UIImage(named: "ic_file_attachment", in: QiscusMultichannelWidget.bundle, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
