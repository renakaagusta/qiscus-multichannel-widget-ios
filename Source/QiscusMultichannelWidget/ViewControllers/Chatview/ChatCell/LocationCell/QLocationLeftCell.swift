...
class QLocationLeftCell: UIBaseChatCell {
    ...
    override func awakeFromNib() {
        ...
        self.locationContainer.tintColor = ColorConfiguration.leftBubbleColor
    ...
    func bindData(message: QMessage){
        ...
        if ChatConfig.showUserNameSender == true {
            ...
            self.lbNameHeightCons.constant = 21
        }else{
            self.lbName.isHidden = true
            self.lbNameHeightCons.constant = 0
        }
    ...
    func setupBalon(message: QMessage){
        ...
        self.ivBaloon.tintColor = ColorConfiguration.leftBubbleColor
        self.ivBaloon.backgroundColor = ColorConfiguration.leftBubbleColor
