...
class QReplyLeftCell: UIBaseChatCell {
    ...
    func bindData(message: QMessage){
        ...
        case .video:
            ...
            self.ivCommentImage.image       = UIImage(named: "ic_file_black" , in: QiscusMultichannelWidget.bundle, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
        ...
        case .location:
            self.tvCommentContent.text = text
            self.ivCommentImage.image = UIImage(named: "map_ico", in: QiscusMultichannelWidget.bundle, compatibleWith: nil)
        case .contact:
            self.tvCommentContent.text = text
            self.ivCommentImage.image = UIImage(named: "contact", in: QiscusMultichannelWidget.bundle, compatibleWith: nil)
            self.ivCommentImage.contentMode = .scaleAspectFit
