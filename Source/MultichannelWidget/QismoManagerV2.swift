...
class QismoManagerV2 {
    
    static let shared : QismoManagerV2 = QismoManagerV2()
    
    var appID: String = ""
    private var userID : String = ""
    private var username : String = ""
    private var avatarUrl: String = ""
    var network : QismoNetworkManagerV2!
    ...
    func setup(appID: String, server : QiscusServer? = nil) {
        ...
        self.network = QismoNetworkManagerV2(qiscusCore: self.qiscus)
